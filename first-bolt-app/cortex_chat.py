...
class CortexChat:
    ...
    def _retrieve_response(self, query: str, limit=1) -> dict[str, any]:
        ...
        data = {
            ...
            "tool_resources": {
                "supply_chain": {"semantic_model_file": "@DASH_DB.DASH_SCHEMA.DASH_SEMANTIC_MODELS/supply_chain_semantic_model.yaml"},
                "support": {"semantic_model_file": "@DASH_DB.DASH_SCHEMA.DASH_SEMANTIC_MODELS/support_tickets_semantic_model.yaml"},
